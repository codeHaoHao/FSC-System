...
<div class=" admin-content">
		...
		<div class="daohang">
			<ul>
				<li><button type="button" onclick="window.location.href='/test5/classBeanInformation.action'" class="am-btn am-btn-default am-radius am-btn-xs"> 返回 </li>
			</ul>
  ...
  <ul>
   ...
   <form class="am-form am-g">
          <table width="90%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <%
			ClassBean classBean = (ClassBean)session.getAttribute("classSchedule");
            for(int i=2;i<=9;i++){
            	%><tr><td>第<%=i %>节</td><%
            	for(int j=1;j<=5;j++){
            		%>	
