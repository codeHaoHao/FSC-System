   ...
   <div class="pagebody">
	 ...
	 <form action="#"method="post">
	  ...
	  <div style="width:820px;height:0px;border-top:1px black dashed;"/>
		...
		%>
        <form action="parentUpdateInformation.action" method="post">
        <input type="hidden" name="id" value="<%=parent.getId()%>">
  <p>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号: <input type="text" name="userName" value="<%=parent.getUserName()%>"/></p>
  <p>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: <input type="text" name="password" value="<%=parent.getPassword()%>" /></p>
  <p>家长姓名: <input type="text" name="parentName" value="<%=parent.getParentName()%>"/></p>
  <p>家长姓别: <input type="text" name="gender" value="<%=parent.getGender()%>"/></p>
  <p>家长职业: <input type="text" name="profession" value="<%=parent.getProfession()%>"/></p>
  <p>工作地点: <input type="text" name="workspace" value="<%=parent.getWorkspace()%>"/></p>
  <p>孩子的id: <input type="text" name="studentIdCard" value="<%=parent.getChild().getIdCard()%>"/></p>
	<p>电话: <input type="text" name="telephone" value="<%=parent.getTelephone()%>"/></p>
  <input type="submit"value="确认修改"id="ds" >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="返回家长首页" onclick="window.location.href='/test5/parentIndex.action'" id="ds">
  </form>
