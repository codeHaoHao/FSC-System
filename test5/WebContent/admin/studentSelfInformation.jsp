   ...
   <div class="pagebody">
	 ...
	 <form action="#"method="post">
	  ...
	  <div style="width:820px;height:0px;border-top:1px black dashed;"/>
		...
		%>
        <form action="studentUpdateSelfInformation.action" method="post">
        <input type="hidden" name="id" value="<%=student.getId()%>">
  <p>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号(idCard): <input readonly="readonly" type="text" name="idCard" value="<%=student.getIdCard()%>"/></p>
  <p>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码: <input type="text" name="password" value="<%=student.getPassword()%>" /></p>
  <p>学生姓名: <input type="text" name="studentName" value="<%=student.getStudentName()%>"/></p>
  <p>学生性别: <input type="text" name="gender" value="<%=student.getGender()%>"/></p>
  <p>身份证: <input type="text" name="idNumber" readonly="readonly" value="<%=student.getIdnumber()%>"/></p>
  <p>入学时间: <input type="text" name="enrollyear" readonly="readonly" value="<%=student.getEnrollyear()%>"/></p>
  <p>班级id: <input type="text" name="classNum" value="<%=student.getClassNum()%>"/></p>

  <input type="submit"value="确认修改"id="ds" >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="返回学生首页" onclick="window.location.href='/test5/studentIndex.action'" id="ds">
  </form>
