...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <h3 class="am-icon-users on"><em></em> <a href="/test5/parentQueryTeacherInformation.action">教师信息查询</a></h3>
    </div>
    <!-- sideMenu End --> 
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 教师情况查询</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 教师情况查询> <a href="#">教师情况</a></dl>
          ...
          <table width="90%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            %>
              <tr>
                ...
                <td><a href="#"><%=commodity.getClassBeanTeacher().getTeacherName() %></a></td>
            	<td><%=commodity.getClassBeanTeacher().getTelephone() %></td>
