...
<div class="admin">
   ...
   %>
   <a class="changeColorByHao" onclick="window.location.href='/test5/teacherFDT.action?id=<%=classBean.getId() %>'">
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 100}">
        <dt class="qs"><i class="am-icon-users"></i></dt>
        <dd style="color:black" class="f12"><b><%=classBean.getClassBeanName() %>班</b></dd>
        <dd style="color:black" class="f12"></dd>
      </dl>
   </a>
   <%} %>
    </div>
    ...
    <a class="changeColorByHao" onclick="window.location.href='/test5/teacherPublishHomework.action'">
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 100}">
        <dt class="qs"><i class="am-icon-users"></i></dt>
        <dd style="color:black" class="f12" ><b>发布作业</b></dd>
        <dd style="color:black" class="f12"></dd>
      </dl>
   </a>
	<a class="changeColorByHao" onclick="window.location.href='/test5/teacherQueryHomeworkInformation.action'">
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 100}">
        <dt class="qs"><i class="am-icon-users"></i></dt>
        <dd style="color:black" class="f12" ><b>查看已发布的作业情况</b></dd>
        <dd style="color:black" class="f12"></dd>
      </dl>
   </a>
   </div>
