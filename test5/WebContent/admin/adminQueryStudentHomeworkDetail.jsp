...
<div class=" admin-content">
		...
		<div class="daohang">
			<ul>
				...
				<li><button type="button" onclick="window.location.href='/test5/adminQueryStudentHomeworkInformation.action?commodity_id=<%=teacherCommodityHomework.getCommodity_id() %>&&teacher_id=<%=teacherCommodityHomework.getTeacher_id() %>'" class="am-btn am-btn-default am-radius am-btn-xs"> 返回 </li>
			</ul>
</div>
<div class="admin-biaogelist">
  ...
  <ul>
   ...
   <div class="am-form am-g">
		  ...
		  <hr/>
		  <br/>
		  <a href="downloadHomework.action?fileName=<%=studentWithHomework2.getWordFilePath()%>">学生word文件下载</a>
		  <%} %>
           <form class="am-form tjlanmu" action="adminCheckStudentHomeworkGrade.action" method="post">
          ...
          <div class="you">
           <input type="hidden" name="id" value="<%=teacherCommodityHomework.getId() %>"/>
		          ...
		          <%if(studentWithHomework2!=null){ %>
          <input type="hidden" style="width: 200px;" name="S_H_id" value="<%=studentWithHomework2.getId() %>" class="am-input-sm">
            <input type="text" style="width: 200px;" name="grade" value="<%=studentWithHomework2.getGrade() %>" class="am-input-sm">
            <%} %>
          </div>
        </div>
      <div class="am-form-group am-cf">
