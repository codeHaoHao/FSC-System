...
<div class="nav-navicon admin-main admin-sidebar">
   ...
   <div class="sideMenu am-icon-dashboard" style="color:#aeb2b7; margin: 10px 0 0 0;"><a href="/test5/studentSelfInformation.action"> 修改个人信息</a></div>
    <div class="sideMenu">
      ...
      <h3 class="am-icon-cart-plus on"><em></em> <a href="/test5/studentQueryClassSchedule.action"> 个人课表查询</a></h3>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 个人课表查询</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 学生首页 > <a href="#">个人课表查询</a></dl>
  ...
  <ul>
    ...
    <form class="am-form am-g">
          <table width="90%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <%
			ClassBean classBean = student.getClassBean();
            for(int i=2;i<=9;i++){
            	%><tr><td>第<%=i %>节</td><%
            	for(int j=1;j<=5;j++){
            		%>	
