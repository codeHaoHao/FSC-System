...
function windowOut(id,uesrName,password,email,phone){
	...
	document.getElementById("studentName").value=uesrName;
...
<div class="am-popup am-popup-inner" id="my-popup" >
      ...
      <h4 class="am-popup-title">添加学生 </h4>
      ...
      <form class="am-form tjlanmu" action="addStudent.action">


       <div class="am-form-group am-cf">
          <div class="zuo">学生姓名：</div>
          <div class="you">
            <input type="text" name="studentName" class="am-input-sm"  placeholder="请输入uesrName">
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" name="idCard" class="am-input-sm"  placeholder="请输入idCard">
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          <div class="zuo">班级id：</div>
          <div class="you">
            <input type="text" name="classNum" class="am-input-sm"  placeholder="请输入phone">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="you">
	...
	<div class="am-popup am-popup-inner" id="my-popups">
	    ...
	    <div class="am-popup-hd">
      <h4 class="am-popup-title">修改学生信息</h4>
      <span data-am-modal-close
            class="am-close">&times;</span>
    </div>
     ...
     <form class="am-form tjlanmu" action="studentInformationUpdate.action" method="post">
		<div class="am-form-group am-cf">
          <div class="zuo">studentId:</div>
          <div class="you">
       ...
       <div class="am-form-group am-cf">
          <div class="zuo">学生姓名：</div>
          <div class="you">
            <input type="text" name="studentName" class="am-input-sm" id="studentName" placeholder="请输入uesrName">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">idCard：</div>
          <div class="you">
            <input type="text" name="idCard" class="am-input-sm" id="email" placeholder="请输入email">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">密码：</div>
        ...
        <div class="am-form-group am-cf">
          <div class="zuo">班级id：</div>
          <div class="you">
            <input type="text" name="classNum" class="am-input-sm" id="phone" placeholder="请输入phone">
          </div>
        </div>
        <div class="am-form-group am-cf">
        <div class="zuo"></div>
...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-type">idCard</th>
                <th class="table-author am-hide-sm-only">密码</th>
                <th class="table-author am-hide-sm-only">班级</th>
                <th class="table-date am-hide-sm-only">成绩信息</th>
                <th class="table-date am-hide-sm-only">作业信息</th>
            ...
            <%
            	...
            	ArrayList<Student> beans = (ArrayList<Student>)session.getAttribute("studentList");
                ...
                <td><%=student.getId() %></td>
                <td><a href="#"><%=student.getStudentName() %></a></td>
                <td><%=student.getIdCard() %></td>
                <td class="am-hide-sm-only"><%=student.getPassword() %></td>
                <td class="am-hide-sm-only"><%=student.getClassNum() %></td>
                <td class="am-hide-sm-only"><a href="/test5/studentInformationWithGrades.action?id=<%=student.getId()%>">查看成绩信息</a></td>
                <td class="am-hide-sm-only"><a href="/test5/adminQueryStudentHomework.action?id=<%=student.getId()%>">查看作业情况</a></td>
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                     ...
                     <intput onclick="windowOut('<%=student.getId() %>', '<%=student.getStudentName() %>', '<%=student.getPassword() %>', '<%=student.getIdCard() %>', '<%=student.getClassNum() %>')"
                     ...
                     <intput type="button" onclick="window.location.href='/test5/deleteStudentById.action?id=<%=student.getId() %>'"  class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单"><span class="am-icon-trash-o" ></span></intput>
                    </div>
                  </div>
                </td>
              </tr>
         ...
         <%
          	if(p!=1) out.print("<li><a href='/test5/studentInformation.action?page="+1+"'"+">«</a></li>");
          %>
          <%
          	if(p>1) out.print("<li><a href='/test5/studentInformation.action?page="+(p-1)+"'"+">‹</a></li>");
          %>
          <%
          	for(int i=3;i>=1;i--){
				if(p-i>=1){
          %>
          <li class=""><a href="/test5/studentInformation.action?page=<%=p-i%>"><%=p-i %></a></li>
          <%}} %>
          <li class="am-active"><a href="/test5/studentInformation.action?page=<%=p%>"><%=p %></a></li>
          <%
          	for(int i=1;i<=3;i++){
				if(p+i<=page_count){
          %>
          ...
          <%}} %>
          <%
          	if(p<page_count) out.print("<li><a href='/test5/studentInformation.action?page="+(p+1)+"'"+">›</a></li>");
          %>
          <%
          	if(p!=page_count)	out.print("<li><a href='/test5/studentInformation.action?page="+page_count+"'"+">»</a></li>");
          %>
