...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
    <h3 class="am-icon-flag on"><em></em> <a href="/test5/studentIndex.action">作业查询</a></h3>
     
      <h3 class="am-icon-cart-plus"><em></em> <a href="/test5/studentQueryClassSchedule.action"> 个人课表查询</a></h3>
     
      <h3 class="am-icon-users"><em></em> <a href="/test5/studentQueryGrade.action">考试成绩查询</a></h3>
    </div>
    <!-- sideMenu End --> 
...
<div class="admin">
   ...
   %>
   <a class="changeColorByHao" onclick="window.location.href='/test5/studentQueryHomework.action?commodity_id=<%=classBeanWithCommodity.getCommodity_id()%>&&teacher_id=<%=classBeanWithCommodity.getTeacher_id()%>'">
